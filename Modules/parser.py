...
def parse():
    ...
    parser.add_argument("-c", "--crt", help="Function for finding solution for chinese remainder theorem. Format -c 1LINE,2LINE,3LINE,... Example: '-c 5mod18,4mod7'")
    parser.add_argument("-i", "--inverse", help="Function for finding inverse number for given number. Format: -i NUM,MOD. Example: '-i 5,9'")
    parser.add_argument("-p", "--phi", help="Function for finding Euler Value of given number. Example: '-p 11'")
    parser.add_argument("--group", help="Function for finding Multiplicative Group of given number. Example: '--group 11'")
    parser.add_argument("--orders_of_group", help="Function for finding orders of all elements of multiplicative group made of given number. Example: '--orders_of_group 13'")
    parser.add_argument("--curve", help="Function for giving program your curve, if no athor function is enabled, program check if given curve is Elliptic. In case first number is negative use '/' instead of '-' (Just ounce!)! "
                                        "Example for EC: y^2 "
    ...
    parser.add_argument("--order_of_ec", help="Function for finding order of given curve. In case first number is negative use '/' instead of '-' "
                                              "(Just ounce!)! Format: --order_of_ec"
                                              "EC + Field must be given! Example: '--curve 1,-1,2,1,-5,3,"
                                              "2  --field 5 --order_of_ec'",
                        action="store_true")
    parser.add_argument("--point_on_curve", help="Function for finding out if given point is on given curve. In case first number is negative use '/' instead of '-' "
                        ...
                        action="store_true")
    parser.add_argument("--add_points_ec", help="Function for adding two given points. In case first number is negative use '/' instead of '-' "
